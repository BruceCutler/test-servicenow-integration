rti_core_account_requests = {
  ...
  bctestaak = {
    control_tower_parameters = {
      AccountEmail              = "awsadmins.rti+aws-low-none-dev-bctestaak@rti.org"
      AccountName               = "AWS-LOW-none-DEV-BCTESTAAK"
      ManagedOrganizationalUnit = "Dev (ou-7w6-sqoqnptq)"
      SSOUserEmail              = "awsadmins.rti+aws-low-none-dev-bctestaak@rti.org"
      SSOUserFirstName          = "Admin"
      SSOUserLastName           = "User"
    }

    account_tags = {
      "Name"             = "AWS-LOW-none-DEV-BCTESTAAK"
      "ChargeCode"       = "n/a"
      "Environment"      = "dev"
      "TerraformManaged" = "true"
      "SupportGroup"     = "RTI GTS Infrastructure and Cloud"
      "ProjectName"      = "bctestaak"
    }
